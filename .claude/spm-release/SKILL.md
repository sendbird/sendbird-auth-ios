...
- Step 3-7: **스킵** (커밋, PR, Release, Package.swift 업데이트 안 함)
...
### Step 5: ⏸️ PR 머지 대기 (수동) → 태그 생성

**PR을 수동으로 머지한 후** 아래 명령어 실행:
...
### Step 6: Public repo GitHub Release 생성

Public repo에 xcframework zip 업로드:
...
### Step 7: Public repo Package.swift 업데이트 → ⏸️ PR 머지 대기 (수동)
