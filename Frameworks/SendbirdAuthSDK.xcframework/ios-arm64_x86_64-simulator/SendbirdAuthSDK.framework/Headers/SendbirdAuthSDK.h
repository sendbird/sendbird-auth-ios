...
#ifndef SENDBIRDAUTHSDK_SWIFT_H
#define SENDBIRDAUTHSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SendbirdAuthSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK11AuthAppInfo")
@interface AuthAppInfo : NSObject
...
SWIFT_PROTOCOL_NAMED("AuthConnectionDelegate")
@protocol SBDAuthConnectionDelegate
@optional
...
/// Invoked when the connecting is delayed. The connection will be automatically retried after <code>retryAfter</code> seconds.
/// This happens when the server is busy due to being overloaded.
/// since:
/// 4.34.0
- (void)didDelayConnectionWithRetryAfter:(NSUInteger)retryAfter;
@end

@class NSCoder;
/// Sendbird error class.
SWIFT_CLASS("_TtC15SendbirdAuthSDK9AuthError")
@interface AuthError : NSError
/// Create error object with Dictionary.
/// \param dict Error Data
///
///
/// returns:
/// <code>AuthError</code> object.
+ (AuthError * _Nullable)errorWithDictionary:(NSDictionary<NSString *, id> * _Nonnull)dict SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// <code>AuthError</code> object.
+ (AuthError * _Nonnull)errorWithNSError:(NSError * _Nonnull)error SWIFT_WARN_UNUSED_RESULT;
/// Create error object
/// \param domain domain.
///
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK23AuthMessageTemplateInfo")
@interface AuthMessageTemplateInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC15SendbirdAuthSDK20AuthNotificationInfo")
@interface AuthNotificationInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_PROTOCOL_NAMED("AuthSessionDelegate")
@protocol SBDAuthSessionDelegate
...
- (void)sessionDidHaveError:(NSError * _Nonnull)error;
@end

SWIFT_CLASS("_TtC15SendbirdAuthSDK8AuthUser")
@interface AuthUser : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface AuthUser (SWIFT_EXTENSION(SendbirdAuthSDK))
@property (nonatomic, readonly) NSUInteger hash;
@end

@interface AuthUser (SWIFT_EXTENSION(SendbirdAuthSDK)) <NSCopying>
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK10BinaryData")
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK17BlockingOperation")
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK18ChatLoggerObserver")
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK10HTTPClient")
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK18InternalInitParams")
@interface InternalInitParams : NSObject
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP15SendbirdAuthSDK13SBLogReceiver_")
@protocol SBLogReceiver
- (void)logMessage:(NSString * _Nonnull)message;
@end

SWIFT_CLASS("_TtC15SendbirdAuthSDK15SBRunloopThread")
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK7SBTimer")
...
SWIFT_CLASS("_TtC15SendbirdAuthSDK22SessionWebSocketEngine")
@interface SessionWebSocketEngine : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSURLSessionWebSocketTask;
@interface SessionWebSocketEngine (SWIFT_EXTENSION(SendbirdAuthSDK)) <NSURLSessionDataDelegate, NSURLSessionWebSocketDelegate>
