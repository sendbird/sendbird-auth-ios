...
extension AnyCodable: Equatable {
    public static func == (lhs: AnyCodable, rhs: AnyCodable) -> Bool {
        ...
        case let (lhs as String, rhs as String):
            return lhs == rhs
        case let (lhs as CGSize, rhs as CGSize):
...
extension AnyCodable: Hashable {
    public func hash(into hasher: inout Hasher) {
        ...
        case let value as CGSize:
            hasher.combine("\(value.width):\(value.height)")
...
extension _AnyDecodable {
    public init(from decoder: Decoder) throws {
        ...
        } else if let size = try? container.decode(CGSize.self) {
            self.init(size)
...
extension _AnyEncodable {
    public func encode(to encoder: Encoder) throws {
        ...
        case let size as CGSize:
            try container.encode("\(size.width),\(size.height)")
        ...
        default:
            ...
            throw EncodingError.invalidValue(value ?? "null", context)
        }
    }
