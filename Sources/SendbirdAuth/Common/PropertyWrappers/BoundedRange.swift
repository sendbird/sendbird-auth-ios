...
@propertyWrapper
package struct BoundedRange<T: AdditiveArithmetic & Comparable> {
...
//                    }
    ...
    package var projectedValue: (T, T) {
        get {
            (min, max)
        }
        set {
    ...
    package init(wrappedValue: T, propertyName: String? = nil, min: T = .zero, max: T, defaultValue: T? = nil) {
